...
export default class extends Component {
  ...
  componentWillMount() {
    this.setState({
      idpekerjaan: this.props.idpekerjaan,
      Nama_Pekerjaan: this.props.Nama_Pekerjaan,
      Upah: this.props.Projek.Upah,
                    ...
                    <div className="ibox-content">
                        <form onSubmit={this.handleSubmit} className="form-horizontal" >
                          ...
                          <div className="form-group">
                            ...
                            <div className="col-sm-10 col-md-6 col-lg-6" >
                              <input type="text" name="Nama_Pemilik_Lahan" className="form-control" value={this.state.Projek} onChange={this.handleChange} />
                            </div>
                          </div>
