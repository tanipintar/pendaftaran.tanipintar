                ...
                <table className="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th className="text-center">Id User</th>
                        ...
                        this.state.dtprojek.map((dt, key) => {
                          return (
                            <tr key={key}>
                              ...
                              <td className="text-center">{dt.data.Id_User}</td>
                              <td className="text-center">{dt.data.Nama_Pemilik_Lahan}</td>
                              <td className="text-center">{dt.data.Luas_Lahan}</td>
                              <td className="text-center">{dt.data.Alamat}</td>
                              <td className="text-center">
                                ...
                                <Link href={{ pathname: '/tambahsop', query: { id: dt.id } }}><a className="btn btn-primary btn-xs" title="Tambah SOP" ><i className="fa fa-plus"></i></a></Link>
