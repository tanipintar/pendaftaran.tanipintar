...
export default class extends Component {
  ...
  componentWillMount() {
    this.setState({
      ...
      // mulaidate : new Date(mulai)
      
      mulai: this.props.Projek.mulai
  ...
  handleChange (evt) {
    ...
    if(evt.target.name == "HST"){
      ...
      var jumpek="1"
      var tglhst=""
      // var newtglawal = new Date(tglawal)
      var tglawal = new Date(this.props.Projek.mulai);
      ...
      nampek="Penyiangan Rumput dan Gulma"
        ...
        jmlh="0"
        harganut="0"
        tglawal.setDate(tglawal.getDate() + 10 )
        tglhst= tglawal.toISOString().substr(0,10)
        ...
        uph="0"
        jmlh="0"
        tglawal.setDate(tglawal.getDate() + 15 )
        tglhst= tglawal.toISOString().substr(0,10)
        ...
        tglawal.setDate(tglawal.getDate() + 16 )
        tglhst= tglawal.toISOString().substr(0,10)
        ...
        tglawal.setDate(tglawal.getDate() + 17 )
        tglhst= tglawal.toISOString().substr(0,10)
        ...
        tglawal.setDate(tglawal.getDate() + 23 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
        ...
        tglawal.setDate(tglawal.getDate() + 25 )
        tglhst= tglawal.toISOString().substr(0,10)
        ...
        tglawal.setDate(tglawal.getDate() + 33 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
        ...
        pk="Pemupukan"
        nampek="Pemupukan Phonska"
        tglawal.setDate(tglawal.getDate() + 37 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
        ...
        tglawal.setDate(tglawal.getDate() + 40 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
        ...
        tglawal.setDate(tglawal.getDate() + 45 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
        ...
        pk="Penyemprotan"
        nampek="Penyemprotan Fungisida"
        tglawal.setDate(tglawal.getDate() + 60 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
      else if(evt.target.value == "HST65"){
        pk="Penyemprotan"
        nampek="Penyemprotan Insektisida"
        tglawal.setDate(tglawal.getDate() + 65 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
      else if(evt.target.value == "HST75"){
        pk="Penyemprotan"
        nampek="Penyemprotan Fungisida"
        tglawal.setDate(tglawal.getDate() + 75 )
        tglhst= tglawal.toISOString().substr(0,10)
      }
        ...
        pk="Panen"
        nampek="Panen"
        tglawal.setDate(tglawal.getDate() + 90 )
        tglhst= tglawal.toISOString().substr(0,10)
                ...
                <div className="ibox float-e-margins">
                    ...
                    <div className="ibox-content">
                        <form onSubmit={this.handleSubmit} className="form-horizontal" >
                          ...
                          <div className="form-group">
                            <label className="col-sm-2 control-label">Tanggal Awal Mulai</label>
                            <div className="col-sm-10 col-md-6 col-lg-6" >
                              <input type="text" name="mulai" className="form-control" value={this.state.mulai} onChange={this.handleChange} />
                            </div>
                          </div>
